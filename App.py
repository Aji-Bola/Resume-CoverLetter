...
class ResumeApp(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.button_row.grid(row=3, column=0, columnspan=3, pady=10, padx=10, sticky="ew")

        ctk.CTkButton(self.button_row, text="Choose Save Folder", command=self.choose_save_folder).grid(row=0, column=0, padx=10)
        ctk.CTkButton(self.button_row, text="Generate Resume", command=self.generate_resume).grid(row=0, column=1, padx=10)
        ctk.CTkButton(self.button_row, text="Generate Cover Letter", command=self.generate_cover_letter).grid(row=0, column=2, padx=10)
        ctk.CTkButton(self.button_row, text="Evaluate Resume", command=self.evaluate_resume).grid(row=0, column=3, padx=10)
